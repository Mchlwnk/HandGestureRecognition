...
namespace HandGestureRecognition
{
    public partial class Form1 : Form
    {
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            Image<Bgr, byte> capturedImage = currentFrame;
            ...
            if (takeMovie)
            {
                if (nextFrame < 500)
                {
                    ...
                    capturedImage.Save(@".\..\..\..\MOVIES\" + nextFrame + ".jpg");
                    //capturedImage.Save(@"C:\Users\piotrek\Desktop\FILMS\" + nextFrame + ".jpg");
                    nextFrame++;
            ...
            if (currentFrame != null)
            {
                ...
                fingerNum = DrawAndComputeFingersNum();

                GestureExecution(fingerNum);
                ...
                {
                    // Save the image
                    skin.Save(@".\..\..\..\PICTURES\" + nextPicture + "binary.jpg");
                    capturedImage.Save(@".\..\..\..\PICTURES\" + nextPicture + ".jpg");
                    //skin.Save(@"C:\Users\piotrek\Desktop\PICTURES\" + nextPicture + "binary.jpg");
                    //capturedImage.Save(@"C:\Users\piotrek\Desktop\PICTURES\" + nextPicture + ".jpg");
                    nextPicture++;
                    // Set the bool to false again to make sure we only take one snapshot
        ...
        private void GestureExecution(int fingerNum) {
            
            
            if (fingerNum == prevNum)
                counter++;
            else
                counter = 0;

            /*if (fingerNum == 5 && counter>10)
            {
                takeSnapshot = !takeSnapshot;
                counter = 0;
            }*/
            if (counter > 10)
            {
                switch (fingerNum)
                {
                    ...
                    case 1:
                        {
                            string sourceDir = @".\..\..\..\PICTURES\";
                            DeletePictures(sourceDir);
                            break;
                        }
                    case 2:
                        {
        ...
        void DeletePictures(string dir)
        {
            try
            {
